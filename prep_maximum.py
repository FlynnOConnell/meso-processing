...
Python has a lot of advantages, some disadvantages, but notably the CaImAn, Suite2p and NormCorre libraries no
longer maintain their MATLAB API.
...
if __name__ == "__main__":
    ...
    # 0.5 - Get some dirty filenaming started
